...
public class BotAi : MonoBehaviour
{
    ...
    [Header("Variables")] public bool seek;
    ...
    [Header("Decisions")] public float distanceSeek;
    public float distanceAttack;
    [Range(0.0f, 1.0f)] public float fleeProbabillity;
    public List<UnitScript> units = new List<UnitScript>();

    [Header("Other")] private Vector3 lastPosition;
